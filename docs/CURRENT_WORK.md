...
- current_phase: `PH Guardrail Keepa Field Impact Analysis完了・独立レビュー準備`
- working_branch: `codex/ph-guardrail-evidence-audit`
- marketplace: `PH`
- module: `事業ポートフォリオ・出品支援ツール`
- next_action: CodexがPH Guardrail Keepa Field Impact Analysisの差分を独立レビューへ提示し、Keepa小規模確認を提案する根拠として妥当か確認する。
...
- PH Guardrail Keepa Field Impact Analysisの独立レビュー（レビュー用分析資料。Guardrail辞書を置換しない）
...
CodexがPH Guardrail Keepa Field Impact Analysisの差分を独立レビューへ提示する。
