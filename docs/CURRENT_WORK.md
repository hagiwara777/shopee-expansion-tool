...
オーナーが画面で「候補生成 → 市場別Gate → Category／Brand準備」の導線が迷わず分かるかを確認する。確認結果に応じて、Codexがpush・Draft PR作成の準備または必要な局所修正を行う。
