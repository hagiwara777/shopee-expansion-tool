...
オーナーが、ASIN Expansion／ASIN Resolverのタブ名、内部管理UIの非表示、および「候補生成 → 市場別Gate → Category／Brand準備」の導線を再確認する。問題なければ、Codexがpush・Draft PR作成の報告を行う。
